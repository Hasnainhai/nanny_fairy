...
class _LoginViewFamilyState extends State<LoginViewFamily> {
  ...
  Future<void> _loginFamily() async {
        ...
        if (currentUser != null) {
          ...
          if (isProvider) {
            ...
            final authController =
                Provider.of<FamilyAuthController>(context, listen: false);
            ...
            Utils.snackBar(
              'Your ID does not match, please log in to the provider section.',
              context,
            );
          }
        } else {
                  ...
                  Row(
                    ...
                    children: [
                      InkWell(
                        onTap: () {
                          Navigator.pushNamed(
                              context, RoutesName.forgetPassFamily);
                        },
                        child: Text(
                          'Forget Password?',
                          style: GoogleFonts.getFont(
