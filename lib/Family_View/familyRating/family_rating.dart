...
class FamilyRating extends StatefulWidget {
  FamilyRating({
    super.key,
  ...
  @override
  State<FamilyRating> createState() => _FamilyRatingState();
}

class _FamilyRatingState extends State<FamilyRating> {
  ...
  Future<void> submitReview() async {
    ...
    try {
      ...
      await Navigator.pushNamedAndRemoveUntil(
          context, RoutesName.dashboardFamily, (routes) => false);
    } catch (error) {
